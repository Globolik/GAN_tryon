...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--checkpoints_dir', type=str, default='/home/alex/GAN_tryon/ACGPN_inference/checkpoints', help='models are saved here')
        ...
        self.parser.add_argument('--dataroot', type=str, default='/home/alex/GAN_tryon/Data_pr')
        #
